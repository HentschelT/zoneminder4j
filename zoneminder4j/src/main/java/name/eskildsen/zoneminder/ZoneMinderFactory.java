...
public class ZoneMinderFactory {
    ...
    public static IZoneMinderConnectionInfo CreateConnection(String protocol, String hostName, Integer portHttp,
            Integer portTelnet, String basePath, String userName, String password, Integer timeout)
            throws GeneralSecurityException {
        return new ZoneMinderConnectionInfo(protocol, hostName, portHttp, portTelnet, basePath, userName, password,
                timeout);
    }

    public static IZoneMinderConnectionInfo CreateConnection(String protocol, String hostName, String basePath,
            String userName, String password) throws GeneralSecurityException {
        return new ZoneMinderConnectionInfo(protocol, hostName, basePath, userName, password);
    }

    public static IZoneMinderSession CreateSession(IZoneMinderConnectionInfo connection)
            throws FailedLoginException, IllegalArgumentException, IOException, ZoneMinderUrlNotFoundException {
    ...
    public static boolean validateLogin(IZoneMinderConnectionInfo connection)
            throws IllegalArgumentException, IOException, ZoneMinderUrlNotFoundException {

        return ZoneMinderEventManager.getInstance().validateLogin(connection);
    }

    public static void SubscribeMonitorEvents(IZoneMinderConnectionInfo connection, String monitorId,
            IZoneMinderEventSubscriber subscriber)
    ...
    public static boolean isZoneMinderUrl(IZoneMinderConnectionInfo connection) {
